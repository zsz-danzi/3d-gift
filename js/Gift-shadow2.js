...
Gift.prototype.threes_init = function(){
	...
	light.shadow.mapSize.width = 512;  // default  限定阴影图的宽度和高度
	light.shadow.mapSize.height = 512; // default  限定阴影图的宽度和高度

	// light.shadow.bias = 0.002; //阴影贴图偏差，在确定曲面是否在阴影中时，从标准化深度添加或减去多少。默认值为0.此处非常小的调整（大约0.0001）可能有助于减少阴影中的伪影

	light.shadow.radius = 2.8; //将此值设置为大于1的值将模糊阴影的边缘。

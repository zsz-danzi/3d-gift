...
Gift.prototype.init = function(opt){
	...
	this.loadModel(function(object){
		...
		new THREE.ObjectLoader().load( '../models/pump.json', function ( model ) {
			...
			self.mixer1 = new THREE.AnimationMixer( model );
			console.log(self.mixer1,222)
			self.mixer1.clipAction( model.animations[ 0 ] ).play();
...
Gift.prototype.animate = function(){
	...
	if(this.mixer1)
	this.mixer1.update( this.clock.getDelta() );
